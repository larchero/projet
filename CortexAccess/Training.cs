...
namespace CortexAccess
{
    public class Training
    {
        ...
        public event EventHandler<ArrayList> OnComDataReceived;
        public event EventHandler<ArrayList> OnMetDataReceived;
        public event EventHandler<ArrayList> OnMotDataReceived;
        ...
        {
            ArrayList data2 = e.Data.ToObject<ArrayList>();
            if (e.StreamName == "sys")
            {
            ...
            {
                OnComDataReceived(this, data2);
            }
            else if (e.StreamName == "met")
            {
                OnMetDataReceived(this, data2);
            }
            else if (e.StreamName == "mot")
            {
                OnMotDataReceived(this, data2);
            }
        }
        ...
        private void SessionActivatedOk(object sender, string sessionId)
        {
            ...
            // Subscribe sys
            List<string> stream = new List<string>() { "sys", "com","met", "mot"};
